...
let favFoods = ['tom yum', 'quesadillas', 'zuppa toscana', 'curry'];
...
console.log('Number of my favorite foods:', favFoods.length);
...
console.log('First food is', favFoods[0]);
// 3.a. TODO: Log the second animal in the array 
console.log('Second food is', favFoods[1]);

// 3.b. TODO: Log the last animal in the array using it's array index 
console.log('Last food is', favFoods[3]);

// 3.c. (STRETCH) TODO: Log the last animal by using the array length, 
//      instead of the exact index number of the last item

console.log('Last food is', favFoods[favFoods.length - 1]);
